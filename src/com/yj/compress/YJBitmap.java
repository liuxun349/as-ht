...
public class YJBitmap {
	...
	private static YJBitmap mFinalBitmap;

	// //////////////////////// config method
	// start////////////////////////////////////
	private YJBitmap(Context context) {
		mContext = context;
	 ...
	 * @return
	 */
	public static synchronized YJBitmap create(Context ctx) {
		if (mFinalBitmap == null) {
			mFinalBitmap = new YJBitmap(ctx.getApplicationContext());
		}
		return mFinalBitmap;
	}
	 ...
	 * @param bitmap
	 */
	public YJBitmap configLoadingImage(Bitmap bitmap) {
	 ...
	 * @param bitmap
	 */
	public YJBitmap configLoadingImage(int resId) {
	 ...
	 * @param bitmap
	 */
	public YJBitmap configLoadfailImage(Bitmap bitmap) {
	 ...
	 * @param resId
	 */
	public YJBitmap configLoadfailImage(int resId) {
	 ...
	 * @param bitmapHeight
	 */
	public YJBitmap configBitmapMaxHeight(int bitmapHeight) {
	 ...
	 * @param bitmapHeight
	 */
	public YJBitmap configBitmapMaxWidth(int bitmapWidth) {
	 ...
	 * @return
	 */
	public YJBitmap configDownlader(Downloader downlader) {
	 ...
	 * @return
	 */
	public YJBitmap configDisplayer(Displayer displayer) {
	 ...
	 * @return
	 */
	public YJBitmap configDiskCachePath(String strPath) {
	 ...
	 *            缓存大小
	 */
	public YJBitmap configMemoryCacheSize(int size) {
	 ...
	 */
	public YJBitmap configMemoryCachePercent(float percent) {
	 ...
	 * @param size
	 */
	public YJBitmap configDiskCacheSize(int size) {
	 ...
	 * @param size
	 */
	public YJBitmap configBitmapLoadThreadSize(int size) {
		if (size >= 1)
	 ...
	 * @return
	 */
	public YJBitmap configRecycleImmediately(boolean recycleImmediately) {
	...
	public void addImageCache(String url, byte[] data) {
		if (!mInit) {
			init();
		}
		mImageCache.addToDiskCache(url, data);
	}

	public void addImageCache(String url, String data) {
		addImageCache(url, new File(data));
	}

	public void addImageCache(String url, File data) {
		addImageCache(url, getBytesFromFile(data));
	}
