...
public class AshtSettings {
	...
	public void setIsAutoLogin(boolean valuse) {
		mPreferences.edit().putBoolean(PreferenceKeys.AUTO_LOGIN, valuse)
				.apply();
	}
	...
	public void setUserPwd(String value) throws Exception {
		...
		mPreferences
				.edit()
				.putString(PreferenceKeys.USER_PWD,
						Des3.encode(value, securityKey)).apply();
	}
	...
	public void setSecurityKeyU(String value) {
		mPreferences.edit().putString(PreferenceKeys.SECURITYKEY_U, value)
				.apply();
	}
	...
	public void setSecurityKeyD(String value) {
		mPreferences.edit().putString(PreferenceKeys.SECURITYKEY_D, value)
				.apply();
	}

	public void setNeadUpdate(Boolean value) {
		mPreferences.edit().putBoolean(PreferenceKeys.NEEDUPDATE, value)
				.apply();
	}

	public Boolean getNeadUpdate() {
		return mPreferences.getBoolean(PreferenceKeys.NEEDUPDATE, false);
	}
	...
	public void setUserId(String value) throws Exception {
		...
		mPreferences
				.edit()
				.putString(PreferenceKeys.USER_ID,
						Des3.encode(value, securityKey)).apply();
	}
	...
	private class PreferenceKeys {
		...
		final static String NEEDUPDATE = "needupdate";
	}
}
